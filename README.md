...
<p align="center">
  Shareable JSDoc documentation generator configuration files and rules
</p>
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/jsdoc-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fjsdoc-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/jsdoc-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14509"><img src="https://img.shields.io/cii/level/14509?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [Structured API Documentation](#structured-api-documentation) — before and after rule comparison
...
Install `@sebastienrousseau/jsdoc-config` as a development dependency:
...
jsdoc takes its configuration file path on the command line.
...
`@sebastienrousseau/jsdoc-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/jsdoc-config` solves this with three deliberate engineering choices:
...
When generating API documentation exclusively through TypeDoc, TSDoc, or Rustdoc rather than standard JSDoc comment blocks.
