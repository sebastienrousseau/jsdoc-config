...
This document describes how @sebastienrousseau/jsdoc-config is run: who decides what, how
...
@sebastienrousseau/jsdoc-config is **maintainer-led**. As of the current release line it has a single
