# `@sebastienrousseau/jsdoc-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/jsdoc-config`.
...
- [x] **Markdown Documentation Support**: Embeds plugins/markdown for inline markdown rendering
- [x] **Recursive Traversal**: Scans source trees up to 10 directory levels deep
- [x] **Modern Template Navigation**: Monospace and clever links enabled for symbol navigation
- [x] **Strict Source Inclusion**: Targeted JS and TS source pattern filters
