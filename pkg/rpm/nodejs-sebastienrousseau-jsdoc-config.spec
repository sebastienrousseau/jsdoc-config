...
%global npm_bare      jsdoc-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-jsdoc-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable JSDoc documentation generator configuration files and rules

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/jsdoc-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/jsdoc-config is a shareable configuration preset with no runtime
